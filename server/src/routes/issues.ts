...
export function issueRoutes(
  ...
  // SHA-1873: agent-initiated execution defer (ScheduleWakeup-style pause).
  // Records a deferred_agent_pause wakeup row so the recovery reconciler does
  // not mistake the intentional pause for a stranded run.
